...
> [中文说明](README.md) | [Change Log](CHANGELOG.md) \
...
Enhance the support of llama.cpp offline models. Thanks the [issue](https://github.com/zyddnys/manga-image-translator/issues/522) of [allegro0132](https://github.com/allegro0132) and [SpaceThing](https://github.com/SpaceThing).

You can find more information in the [中文说明](README.md).
